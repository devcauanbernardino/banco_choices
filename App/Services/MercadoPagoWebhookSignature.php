...
/**
 * Valida o cabeçalho x-signature das notificações (quando MP_WEBHOOK_SECRET está definido).
 * Referência: documentação oficial de Webhooks Mercado Pago (manifest + HMAC-SHA256).
 */
